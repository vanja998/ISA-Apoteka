...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers(HttpMethod.POST, "/auth/**","/medications/MedicationsSearch","/pharmacy/PharmaciesSearch","/pharmacy/PharmaciesSearchbyaddress","/pharmacy/filterbyrating");
        web.ignoring().antMatchers(HttpMethod.GET, "/", "/webjars/**", "/favicon.ico",
				"/**/*.css", "/**/*.js", "/favicon.ico", "/**/*.html","/pharmacy/allpharmacies","/medications/allmedications","/pharmacy/allpharmaciessortbyname","/pharmacy/allpharmaciessortbyaddress","/pharmacy/allpharmaciessortbyrating");
